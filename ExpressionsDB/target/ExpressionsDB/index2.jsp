...
function setExpressionData(response){
	if(response!=null){
		for(data in response){
			var str = "<tr><td>"+response[data].id+"</td><td><pre><textarea rows='3' cols='30' disabled>"+response[data].namespace+"."+response[data].referenceName+"</textarea></pre></td><td><pre><textarea rows = '3' cols = '50' disabled>"+response[data].expression+"</textarea></pre></td>"; 
